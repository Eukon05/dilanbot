...
@Component
public class MusicSkipMessageListener implements MessageCreateListener {
    ...
    @Autowired
    public MusicSkipMessageListener(ServerService serverService, PlayerManager playerManager){
