...
public abstract class MusicCommand extends Command {
    ...
    protected MusicCommand(String prefix, CommandRepository commandRepository) {
        super(prefix, commandRepository);
    }
    ...
    protected abstract void run(MessageCreateEvent event, DiscordServer discordServer, String[] arguments, User me, ServerMusicManager manager);
